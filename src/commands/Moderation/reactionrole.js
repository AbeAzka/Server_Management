...
module.exports ={
    ...
    .addRoleOption(option => option.setName('role1').setDescription(`This is the first role you want to setup`).setRequired(true))
    .addRoleOption(option => option.setName('role2').setDescription(`This is the second role you want to setup`).setRequired(true))
    .addRoleOption(option => option.setName('role3').setDescription(`This is the third role you want to setup`).setRequired(true)),
    async execute (interaction, client){
        ...
        .setDescription(`React with the button belows to get the specified roles! (${role1}, ${role2}, ${role3})`)
        ...
        collector.on('collect', async (i) =>{
            ...
            if(i.customId === 'button1'){
                ...
                i.reply({content: `You now have then role : ${role1.name}`, ephemeral: true});
            }
