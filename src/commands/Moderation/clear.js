...
module.exports={
    ...
    .setName("clear")
    .setDescription("Deletes a spesific number of messages from a channel")
    ...
    async execute(interaction, client){
        ...
        if(!interaction.member.permissions.has(PermissionsBitField.Flags.ManageMessages)) return await interaction.reply({content: "You don't have permission to execute this command!", ephemeral: true})
