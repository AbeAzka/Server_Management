...
module.exports={
    ...
    .setName('ban')
    .setDescription('This is for ban member')
    .addUserOption(option=>option.setName('user').setDescription(`The member you want to ban`).setRequired(true))
    .addStringOption(option => option.setName('reason').setDescription(`the reason for ban member`).setRequired(true)),
    async execute(interaction,client){
        ...
        .setColor("Aqua")
        .setDescription(`:white_check_mark: You have been banned from **${interaction.guild.member}** | ${reason}`)
